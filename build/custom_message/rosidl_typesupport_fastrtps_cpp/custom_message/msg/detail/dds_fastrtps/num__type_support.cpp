...
#include "custom_message/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_message::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_message::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const custom_message::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_message::msg::Num *>(
    untyped_ros_message);
...
{
  return &custom_message::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_message, msg, Num)() {
  return &custom_message::msg::typesupport_fastrtps_cpp::_Num__handle;
}
