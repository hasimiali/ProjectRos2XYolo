...
#include "pesan/msg/detail/mission__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pesan::msg::Mission & ros_message,
...
{
  auto typed_message =
    static_cast<const pesan::msg::Mission *>(
    untyped_ros_message);
...
{
  return &pesan::msg::typesupport_fastrtps_cpp::_Mission__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pesan, msg, Mission)() {
  return &pesan::msg::typesupport_fastrtps_cpp::_Mission__handle;
}
