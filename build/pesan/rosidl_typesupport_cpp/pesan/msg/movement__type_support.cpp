...
static const _Movement_type_support_symbol_names_t _Movement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pesan, msg, Movement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pesan, msg, Movement)),
  }
};
...
{
  return &::pesan::msg::rosidl_typesupport_cpp::Movement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pesan, msg, Movement)() {
  return get_message_type_support_handle<pesan::msg::Movement>();
}
