...
if(_pesan_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED pesan_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(pesan_FOUND FALSE)
  elseif(NOT pesan_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(pesan_FOUND FALSE)
  endif()
  return()
endif()
set(_pesan_CONFIG_INCLUDED TRUE)

# output package information
if(NOT pesan_FIND_QUIETLY)
  message(STATUS "Found pesan: 0.0.0 (${pesan_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'pesan' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${pesan_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(pesan_FOUND_AMENT_PACKAGE TRUE)
