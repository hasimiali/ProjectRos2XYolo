...
{
  new (message_memory) pesan::msg::Mission(_init);
}

void Mission_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pesan::msg::Mission *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mission_message_member_array[1] = {
  {
    ...
    offsetof(pesan::msg::Mission, mission),  // bytes offset in struct
...
{
  return &::pesan::msg::rosidl_typesupport_introspection_cpp::Mission_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pesan, msg, Mission)() {
  return &::pesan::msg::rosidl_typesupport_introspection_cpp::Mission_message_type_support_handle;
}
