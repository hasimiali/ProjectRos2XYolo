...
bool pesan__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pesan.msg._mission.Mission", full_classname_dest, 26) == 0);
  }
  pesan__msg__Mission * ros_message = _ros_message;
  {  // mission
...
PyObject * pesan__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pesan.msg._mission");
